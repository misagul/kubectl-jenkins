...
echo password: $(kubectl exec -it $(kubectl get pods -n jenkins -o name | grep '^pod/jenkins') -n jenkins -c jenkins -- cat /var/jenkins_home/secrets/initialAdminPassword)
